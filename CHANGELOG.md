...
- **Demo lives in [go9/lantern-demo](https://github.com/go9/lantern-demo).**
  `examples/demo`, the demo Dockerfile, `flicker.toml`, and
  `.github/workflows/demo.yml` are removed from this repo. The live demo URL
  is unchanged.
